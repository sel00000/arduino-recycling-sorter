...
- 정전 용량식 레벨계 측정 원리 (Endress+Hauser) — https://youtu.be/n5pGu-LuJXY
- 정전용량 터치센서란? 센서 구현하기 (오픈랩) — https://m.blog.naver.com/roboholic84/221372823607
...
- Inductive vs. capacitive sensors (SENSOR PARTNERS) — https://www.sensorpartners.com/en/knowledge-base/the-difference-between-inductive-and-capacitive-sensors/
- 아두이노 유도형 근접 센서 사용하기 (Miracle) — https://m.blog.naver.com/PostView.naver?isHttpsRedirect=true&blogId=123gtf&logNo=221233489523
- Tech Tip: Inductive vs Capacitive Sensors (Ramco) — https://www.ramcoi.com/blog/220/tech-tip-inductive-vs-capacitive-sensors
- 정전용량식 근접센서의 원리 — https://article2.tistory.com/824
- 그림으로 이해하는 근접 센서 기초 (픽써엘) — https://youtu.be/-b_IYP74aPs
- 근접센서 PNP DC24V 원리 이해 (볼트메이커) — https://youtu.be/jbym2VNjBPM
- CR18-8DP/8DN/8AO 정전용량 센서의 모든 것 (장갑낀 맥가이버) — https://youtu.be/0xn9uTSGfj0
- 근접 센서 (센서로세계로미래로) — https://m.blog.naver.com/iotsensor/221469817024
- 점유·이동·근접 센서 (KOCW 충남대 강의자료) — http://contents.kocw.or.kr/KOCW/document/2016/chungnam/chahanju/9.pdf
...
- 재활용쓰레기 분류 AI 로봇 (ITmoda) — https://youtu.be/6yUbOwQcC6w
- 재활용 선별장 첨단화 — 플라스틱 재질까지 구별 (뉴스트리) — https://youtu.be/AD_57RcEiIY
- 재활용품 분류의 달인 (SBS 생활의 달인 559회) — https://youtu.be/iv1eyqVMFCM
...
- Conveyor belt toy (MrMickPosner) — https://youtu.be/2aVdOXWo-2Q
- Low Cost Automatic Multi-Purpose Mini Conveyor Belt (Miheer Maniar) — https://youtu.be/udW1BXp7NXw
...
- Servo Motors, how do they work? (The Engineering Mindset) — https://youtu.be/1WnGv-DPexc
- Servo Motor with Arduino MG996 (SDev Electronics) — https://youtu.be/WPQNad2gvEs
- 서보모터 떨림 현상 원인 — 전류 부족/GND 미연결 (for Makers) — https://youtu.be/qywuAx00x2k
- Servo motors vibration problem: solution with capacitor (Global Spy Hawk) — https://youtu.be/zasQSK4CulE
